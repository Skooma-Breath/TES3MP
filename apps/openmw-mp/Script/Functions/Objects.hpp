...
#define OBJECTAPI \
    SCRIPT_FUNCTION("ReadReceivedObjectList", ObjectFunctions::ReadReceivedObjectList),\
    \
    SCRIPT_FUNCTION("ClearObjectList", ObjectFunctions::ClearObjectList),\
    SCRIPT_FUNCTION("SetObjectListPid", ObjectFunctions::SetObjectListPid),\
    \
    SCRIPT_FUNCTION("CopyReceivedObjectListToStore", ObjectFunctions::CopyReceivedObjectListToStore),\
    \
    SCRIPT_FUNCTION("GetObjectListSize", ObjectFunctions::GetObjectListSize),\
    SCRIPT_FUNCTION("GetObjectListOrigin", ObjectFunctions::GetObjectListOrigin),\
    SCRIPT_FUNCTION("GetObjectListClientScript", ObjectFunctions::GetObjectListClientScript),\
    SCRIPT_FUNCTION("GetObjectListAction", ObjectFunctions::GetObjectListAction),\
    SCRIPT_FUNCTION("GetObjectListConsoleCommand", ObjectFunctions::GetObjectListConsoleCommand),\
    SCRIPT_FUNCTION("GetObjectListContainerSubAction", ObjectFunctions::GetObjectListContainerSubAction),\
    \
    SCRIPT_FUNCTION("IsObjectPlayer", ObjectFunctions::IsObjectPlayer),\
    SCRIPT_FUNCTION("GetObjectPid", ObjectFunctions::GetObjectPid),\
    SCRIPT_FUNCTION("GetObjectRefId", ObjectFunctions::GetObjectRefId),\
    SCRIPT_FUNCTION("GetObjectRefNum", ObjectFunctions::GetObjectRefNum),\
    SCRIPT_FUNCTION("GetObjectMpNum", ObjectFunctions::GetObjectMpNum),\
    SCRIPT_FUNCTION("GetObjectCount", ObjectFunctions::GetObjectCount),\
    SCRIPT_FUNCTION("GetObjectCharge", ObjectFunctions::GetObjectCharge),\
    SCRIPT_FUNCTION("GetObjectEnchantmentCharge", ObjectFunctions::GetObjectEnchantmentCharge),\
    SCRIPT_FUNCTION("GetObjectSoul", ObjectFunctions::GetObjectSoul),\
    SCRIPT_FUNCTION("GetObjectGoldValue", ObjectFunctions::GetObjectGoldValue),\
    SCRIPT_FUNCTION("GetObjectScale", ObjectFunctions::GetObjectScale),\
    SCRIPT_FUNCTION("GetObjectSoundId", ObjectFunctions::GetObjectSoundId),\
    SCRIPT_FUNCTION("GetObjectState", ObjectFunctions::GetObjectState),\
    SCRIPT_FUNCTION("GetObjectDoorState", ObjectFunctions::GetObjectDoorState),\
    SCRIPT_FUNCTION("GetObjectLockLevel", ObjectFunctions::GetObjectLockLevel),\
    SCRIPT_FUNCTION("GetObjectDialogueChoiceType", ObjectFunctions::GetObjectDialogueChoiceType),\
    SCRIPT_FUNCTION("GetObjectDialogueChoiceTopic", ObjectFunctions::GetObjectDialogueChoiceTopic),\
    SCRIPT_FUNCTION("GetObjectGoldPool", ObjectFunctions::GetObjectGoldPool),\
    SCRIPT_FUNCTION("GetObjectLastGoldRestockHour", ObjectFunctions::GetObjectLastGoldRestockHour),\
    SCRIPT_FUNCTION("GetObjectLastGoldRestockDay", ObjectFunctions::GetObjectLastGoldRestockDay),\
    \
    SCRIPT_FUNCTION("DoesObjectHavePlayerActivating", ObjectFunctions::DoesObjectHavePlayerActivating),\
    SCRIPT_FUNCTION("GetObjectActivatingPid", ObjectFunctions::GetObjectActivatingPid),\
    SCRIPT_FUNCTION("GetObjectActivatingRefId", ObjectFunctions::GetObjectActivatingRefId),\
    SCRIPT_FUNCTION("GetObjectActivatingRefNum", ObjectFunctions::GetObjectActivatingRefNum),\
    SCRIPT_FUNCTION("GetObjectActivatingMpNum", ObjectFunctions::GetObjectActivatingMpNum),\
    SCRIPT_FUNCTION("GetObjectActivatingName", ObjectFunctions::GetObjectActivatingName),\
    \
    SCRIPT_FUNCTION("GetObjectHitSuccess", ObjectFunctions::GetObjectHitSuccess),\
    SCRIPT_FUNCTION("GetObjectHitDamage", ObjectFunctions::GetObjectHitDamage),\
    SCRIPT_FUNCTION("GetObjectHitBlock", ObjectFunctions::GetObjectHitBlock),\
    SCRIPT_FUNCTION("GetObjectHitKnockdown", ObjectFunctions::GetObjectHitKnockdown),\
    SCRIPT_FUNCTION("DoesObjectHavePlayerHitting", ObjectFunctions::DoesObjectHavePlayerHitting),\
    SCRIPT_FUNCTION("GetObjectHittingPid", ObjectFunctions::GetObjectHittingPid),\
    SCRIPT_FUNCTION("GetObjectHittingRefId", ObjectFunctions::GetObjectHittingRefId),\
    SCRIPT_FUNCTION("GetObjectHittingRefNum", ObjectFunctions::GetObjectHittingRefNum),\
    SCRIPT_FUNCTION("GetObjectHittingMpNum", ObjectFunctions::GetObjectHittingMpNum),\
    SCRIPT_FUNCTION("GetObjectHittingName", ObjectFunctions::GetObjectHittingName),\
    \
    SCRIPT_FUNCTION("GetObjectSummonState", ObjectFunctions::GetObjectSummonState),\
    SCRIPT_FUNCTION("GetObjectSummonEffectId", ObjectFunctions::GetObjectSummonEffectId),\
    SCRIPT_FUNCTION("GetObjectSummonSpellId", ObjectFunctions::GetObjectSummonSpellId),\
    SCRIPT_FUNCTION("GetObjectSummonDuration", ObjectFunctions::GetObjectSummonDuration),\
    SCRIPT_FUNCTION("DoesObjectHavePlayerSummoner", ObjectFunctions::DoesObjectHavePlayerSummoner),\
    SCRIPT_FUNCTION("GetObjectSummonerPid", ObjectFunctions::GetObjectSummonerPid),\
    SCRIPT_FUNCTION("GetObjectSummonerRefId", ObjectFunctions::GetObjectSummonerRefId),\
    SCRIPT_FUNCTION("GetObjectSummonerRefNum", ObjectFunctions::GetObjectSummonerRefNum),\
    SCRIPT_FUNCTION("GetObjectSummonerMpNum", ObjectFunctions::GetObjectSummonerMpNum),\
    \
    SCRIPT_FUNCTION("GetObjectPosX", ObjectFunctions::GetObjectPosX),\
    SCRIPT_FUNCTION("GetObjectPosY", ObjectFunctions::GetObjectPosY),\
    SCRIPT_FUNCTION("GetObjectPosZ", ObjectFunctions::GetObjectPosZ),\
    SCRIPT_FUNCTION("GetObjectRotX", ObjectFunctions::GetObjectRotX),\
    SCRIPT_FUNCTION("GetObjectRotY", ObjectFunctions::GetObjectRotY),\
    SCRIPT_FUNCTION("GetObjectRotZ", ObjectFunctions::GetObjectRotZ),\
    \
    SCRIPT_FUNCTION("GetVideoFilename", ObjectFunctions::GetVideoFilename),\
    \
    SCRIPT_FUNCTION("GetClientLocalsSize", ObjectFunctions::GetClientLocalsSize),\
    SCRIPT_FUNCTION("GetClientLocalInternalIndex", ObjectFunctions::GetClientLocalInternalIndex),\
    SCRIPT_FUNCTION("GetClientLocalVariableType", ObjectFunctions::GetClientLocalVariableType),\
    SCRIPT_FUNCTION("GetClientLocalIntValue", ObjectFunctions::GetClientLocalIntValue),\
    SCRIPT_FUNCTION("GetClientLocalFloatValue", ObjectFunctions::GetClientLocalFloatValue),\
    \
    SCRIPT_FUNCTION("GetContainerChangesSize", ObjectFunctions::GetContainerChangesSize),\
    SCRIPT_FUNCTION("GetContainerItemRefId", ObjectFunctions::GetContainerItemRefId),\
    SCRIPT_FUNCTION("GetContainerItemCount", ObjectFunctions::GetContainerItemCount),\
    SCRIPT_FUNCTION("GetContainerItemCharge", ObjectFunctions::GetContainerItemCharge),\
    SCRIPT_FUNCTION("GetContainerItemEnchantmentCharge", ObjectFunctions::GetContainerItemEnchantmentCharge),\
    SCRIPT_FUNCTION("GetContainerItemSoul", ObjectFunctions::GetContainerItemSoul),\
    SCRIPT_FUNCTION("GetContainerItemActionCount", ObjectFunctions::GetContainerItemActionCount),\
    \
    SCRIPT_FUNCTION("DoesObjectHaveContainer", ObjectFunctions::DoesObjectHaveContainer),\
    SCRIPT_FUNCTION("IsObjectDroppedByPlayer", ObjectFunctions::IsObjectDroppedByPlayer),\
    \
    SCRIPT_FUNCTION("SetObjectListCell", ObjectFunctions::SetObjectListCell),\
    SCRIPT_FUNCTION("SetObjectListAction", ObjectFunctions::SetObjectListAction),\
    SCRIPT_FUNCTION("SetObjectListContainerSubAction", ObjectFunctions::SetObjectListContainerSubAction),\
    SCRIPT_FUNCTION("SetObjectListConsoleCommand", ObjectFunctions::SetObjectListConsoleCommand),\
    \
    SCRIPT_FUNCTION("SetObjectRefId", ObjectFunctions::SetObjectRefId),\
    SCRIPT_FUNCTION("SetObjectRefNum", ObjectFunctions::SetObjectRefNum),\
    SCRIPT_FUNCTION("SetObjectMpNum", ObjectFunctions::SetObjectMpNum),\
    SCRIPT_FUNCTION("SetObjectCount", ObjectFunctions::SetObjectCount),\
    SCRIPT_FUNCTION("SetObjectCharge", ObjectFunctions::SetObjectCharge),\
    SCRIPT_FUNCTION("SetObjectEnchantmentCharge", ObjectFunctions::SetObjectEnchantmentCharge),\
    SCRIPT_FUNCTION("SetObjectSoul", ObjectFunctions::SetObjectSoul),\
    SCRIPT_FUNCTION("SetObjectGoldValue", ObjectFunctions::SetObjectGoldValue),\
    SCRIPT_FUNCTION("SetObjectScale", ObjectFunctions::SetObjectScale),\
    SCRIPT_FUNCTION("SetObjectState", ObjectFunctions::SetObjectState),\
    SCRIPT_FUNCTION("SetObjectLockLevel", ObjectFunctions::SetObjectLockLevel),\
    SCRIPT_FUNCTION("SetObjectDialogueChoiceType", ObjectFunctions::SetObjectDialogueChoiceType),\
    SCRIPT_FUNCTION("SetObjectDialogueChoiceTopic", ObjectFunctions::SetObjectDialogueChoiceTopic),\
    SCRIPT_FUNCTION("SetObjectGoldPool", ObjectFunctions::SetObjectGoldPool),\
    SCRIPT_FUNCTION("SetObjectLastGoldRestockHour", ObjectFunctions::SetObjectLastGoldRestockHour),\
    SCRIPT_FUNCTION("SetObjectLastGoldRestockDay", ObjectFunctions::SetObjectLastGoldRestockDay),\
    SCRIPT_FUNCTION("SetObjectDisarmState", ObjectFunctions::SetObjectDisarmState),\
    SCRIPT_FUNCTION("SetObjectDroppedByPlayerState", ObjectFunctions::SetObjectDroppedByPlayerState),\
    SCRIPT_FUNCTION("SetObjectPosition", ObjectFunctions::SetObjectPosition),\
    SCRIPT_FUNCTION("SetObjectRotation", ObjectFunctions::SetObjectRotation),\
    SCRIPT_FUNCTION("SetObjectSound", ObjectFunctions::SetObjectSound),\
    \
    SCRIPT_FUNCTION("SetObjectSummonState", ObjectFunctions::SetObjectSummonState),\
    SCRIPT_FUNCTION("SetObjectSummonEffectId", ObjectFunctions::SetObjectSummonEffectId),\
    SCRIPT_FUNCTION("SetObjectSummonSpellId", ObjectFunctions::SetObjectSummonSpellId),\
    SCRIPT_FUNCTION("SetObjectSummonDuration", ObjectFunctions::SetObjectSummonDuration),\
    SCRIPT_FUNCTION("SetObjectSummonerPid", ObjectFunctions::SetObjectSummonerPid),\
    SCRIPT_FUNCTION("SetObjectSummonerRefNum", ObjectFunctions::SetObjectSummonerRefNum),\
    SCRIPT_FUNCTION("SetObjectSummonerMpNum", ObjectFunctions::SetObjectSummonerMpNum),\
    \
    SCRIPT_FUNCTION("SetObjectActivatingPid", ObjectFunctions::SetObjectActivatingPid),\
    \
    SCRIPT_FUNCTION("SetObjectDoorState", ObjectFunctions::SetObjectDoorState),\
    SCRIPT_FUNCTION("SetObjectDoorTeleportState", ObjectFunctions::SetObjectDoorTeleportState),\
    SCRIPT_FUNCTION("SetObjectDoorDestinationCell", ObjectFunctions::SetObjectDoorDestinationCell),\
    SCRIPT_FUNCTION("SetObjectDoorDestinationPosition", ObjectFunctions::SetObjectDoorDestinationPosition),\
    SCRIPT_FUNCTION("SetObjectDoorDestinationRotation", ObjectFunctions::SetObjectDoorDestinationRotation),\
    \
    SCRIPT_FUNCTION("SetPlayerAsObject", ObjectFunctions::SetPlayerAsObject),\
    \
    SCRIPT_FUNCTION("SetContainerItemRefId", ObjectFunctions::SetContainerItemRefId),\
    SCRIPT_FUNCTION("SetContainerItemCount", ObjectFunctions::SetContainerItemCount),\
    SCRIPT_FUNCTION("SetContainerItemCharge", ObjectFunctions::SetContainerItemCharge),\
    SCRIPT_FUNCTION("SetContainerItemEnchantmentCharge", ObjectFunctions::SetContainerItemEnchantmentCharge),\
    SCRIPT_FUNCTION("SetContainerItemSoul", ObjectFunctions::SetContainerItemSoul),\
    \
    SCRIPT_FUNCTION("SetContainerItemActionCountByIndex", ObjectFunctions::SetContainerItemActionCountByIndex),\
    \
    SCRIPT_FUNCTION("AddObject", ObjectFunctions::AddObject),\
    SCRIPT_FUNCTION("AddClientLocalInteger", ObjectFunctions::AddClientLocalInteger),\
    SCRIPT_FUNCTION("AddClientLocalFloat", ObjectFunctions::AddClientLocalFloat),\
    SCRIPT_FUNCTION("AddContainerItem", ObjectFunctions::AddContainerItem),\
    \
    SCRIPT_FUNCTION("SendObjectActivate", ObjectFunctions::SendObjectActivate),\
    SCRIPT_FUNCTION("SendObjectPlace", ObjectFunctions::SendObjectPlace),\
    SCRIPT_FUNCTION("SendObjectSpawn", ObjectFunctions::SendObjectSpawn),\
    SCRIPT_FUNCTION("SendObjectDelete", ObjectFunctions::SendObjectDelete),\
    SCRIPT_FUNCTION("SendObjectLock", ObjectFunctions::SendObjectLock),\
    SCRIPT_FUNCTION("SendObjectDialogueChoice", ObjectFunctions::SendObjectDialogueChoice),\
    SCRIPT_FUNCTION("SendObjectMiscellaneous", ObjectFunctions::SendObjectMiscellaneous),\
    SCRIPT_FUNCTION("SendObjectRestock", ObjectFunctions::SendObjectRestock),\
    SCRIPT_FUNCTION("SendObjectTrap", ObjectFunctions::SendObjectTrap),\
    SCRIPT_FUNCTION("SendObjectScale", ObjectFunctions::SendObjectScale),\
    SCRIPT_FUNCTION("SendObjectSound", ObjectFunctions::SendObjectSound),\
    SCRIPT_FUNCTION("SendObjectState", ObjectFunctions::SendObjectState),\
    SCRIPT_FUNCTION("SendObjectMove", ObjectFunctions::SendObjectMove),\
    SCRIPT_FUNCTION("SendObjectRotate", ObjectFunctions::SendObjectRotate),\
    SCRIPT_FUNCTION("SendDoorState", ObjectFunctions::SendDoorState),\
    SCRIPT_FUNCTION("SendDoorDestination", ObjectFunctions::SendDoorDestination),\
    SCRIPT_FUNCTION("SendContainer", ObjectFunctions::SendContainer),\
    SCRIPT_FUNCTION("SendVideoPlay", ObjectFunctions::SendVideoPlay),\
    SCRIPT_FUNCTION("SendClientScriptLocal", ObjectFunctions::SendClientScriptLocal),\
    SCRIPT_FUNCTION("SendConsoleCommand", ObjectFunctions::SendConsoleCommand),\
    \
    SCRIPT_FUNCTION("ReadLastObjectList", ObjectFunctions::ReadLastObjectList),\
    SCRIPT_FUNCTION("ReadLastEvent", ObjectFunctions::ReadLastEvent),\
    SCRIPT_FUNCTION("InitializeObjectList", ObjectFunctions::InitializeObjectList),\
    SCRIPT_FUNCTION("InitializeEvent", ObjectFunctions::InitializeEvent),\
    SCRIPT_FUNCTION("CopyLastObjectListToStore", ObjectFunctions::CopyLastObjectListToStore),\
    SCRIPT_FUNCTION("GetObjectChangesSize", ObjectFunctions::GetObjectChangesSize),\
    SCRIPT_FUNCTION("GetEventAction", ObjectFunctions::GetEventAction),\
    SCRIPT_FUNCTION("GetEventContainerSubAction", ObjectFunctions::GetEventContainerSubAction),\
    SCRIPT_FUNCTION("GetObjectRefNumIndex", ObjectFunctions::GetObjectRefNumIndex),\
    SCRIPT_FUNCTION("GetObjectSummonerRefNumIndex", ObjectFunctions::GetObjectSummonerRefNumIndex),\
    SCRIPT_FUNCTION("SetEventCell", ObjectFunctions::SetEventCell),\
    SCRIPT_FUNCTION("SetEventAction", ObjectFunctions::SetEventAction),\
    SCRIPT_FUNCTION("SetEventConsoleCommand", ObjectFunctions::SetEventConsoleCommand),\
    SCRIPT_FUNCTION("SetObjectRefNumIndex", ObjectFunctions::SetObjectRefNumIndex),\
    SCRIPT_FUNCTION("AddWorldObject", ObjectFunctions::AddWorldObject)
